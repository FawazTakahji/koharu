...
Enable **Use official PyTorch builds**. This replaces Koharu's bundled build with the official one and may improve CPU inference speed. Official builds are stored separately in the package cache, and the change applies on the next launch.
